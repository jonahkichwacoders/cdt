...
public class VT100TerminalControl implements ITerminalControlForText, ITerminalControl, ITerminalViewControl {
	 ...
	 */
	private final IPreferenceChangeListener fPreferenceListener = this::updatePreferences;
	...
	public VT100TerminalControl(ITerminalListener target, Composite wndParent, ITerminalConnector[] connectors,
		...
		this(target, wndParent, connectors,
				useCommonPrefs ? InstanceScope.INSTANCE.getNode(TerminalPlugin.PLUGIN_ID) : null);
	}
	...
	public void disposeTerminal() {
		...
		if (fPreferenceStore != null) {
			fPreferenceStore.removePreferenceChangeListener(fPreferenceListener);
		}
	...
	public void setupTerminal(Composite parent) {
		...
		if (fPreferenceStore != null && wasDisposed) {
			...
			fPreferenceStore.addPreferenceChangeListener(fPreferenceListener);
		}
	...
	private String getFontDefinition() {
		String definition;
		if (fPreferenceStore != null) {
			definition = fPreferenceStore.get(ITerminalConstants.PREF_FONT_DEFINITION,
					ITerminalConstants.DEFAULT_FONT_DEFINITION);
		} else {
